...
public class BrsCloudCpeExistSuccessTest extends TestManager {
    ...
    private static final String CREATE_BRS_CLOUDCPE_TESTCASE =
            "src/integration-test/resources/cloudcpe/testcase/createbrscloudcpe.json";
    ...
    public void successTest() throws ServiceException {
        ...
        HttpRquestResponse httpCreateBrsCloudCpeObject =
                HttpModelUtils.praseHttpRquestResponseFromFile(CREATE_BRS_CLOUDCPE_TESTCASE);
        HttpRequest httpCreateBrsCloudCpeRequest = httpCreateBrsCloudCpeObject.getRequest();
        Map<String, NetworkElementMO> neData = JsonUtil.fromJson(httpCreateBrsCloudCpeRequest.getData(),
        ...
        httpCreateBrsCloudCpeRequest.setData(JsonUtil.toJson(neData));
        execTestCase(httpCreateBrsCloudCpeRequest, new StatusChecker(httpCreateBrsCloudCpeObject.getResponse()));
