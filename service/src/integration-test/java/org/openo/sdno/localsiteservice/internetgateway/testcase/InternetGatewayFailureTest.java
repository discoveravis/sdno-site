...
public class InternetGatewayFailureTest extends TestManager {

    private static final String QUERY_UNEXIST_TESTCASE =
            "src/integration-test/resources/internetgateway/testcase/queryunexistinternetgateway.json";

    @Test
    public void queryUnExistSubnetTest() throws ServiceException {
        HttpRquestResponse httpQueryIntGatewayObject =
                HttpModelUtils.praseHttpRquestResponseFromFile(QUERY_UNEXIST_TESTCASE);
        execTestCase(httpQueryIntGatewayObject.getRequest(),
                new StatusChecker(httpQueryIntGatewayObject.getResponse()));
    }
