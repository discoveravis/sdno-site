...
public class VlanPortsNullTest extends TestManager {
    ...
    private static final String CREATE_VLAN_TESTCASE =
            "src/integration-test/resources/vlan/testcase/createvlanportsnull.json";
