...
public class VlanResponseHandler extends MocoResponseHandler {
    ...
    public void processRequestandResponse(HttpRquestResponse httpObject) {
        ...
        List<SbiIfVlan> inputInstanceList = JsonUtil.fromJson(httpRequest.getData(), new TypeReference<List<SbiIfVlan>>() {});
        ResultRsp<List<SbiIfVlan>> newResult = new ResultRsp<List<SbiIfVlan>>(ErrorCode.OVERLAYVPN_SUCCESS);
