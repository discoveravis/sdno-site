...
package org.openo.sdno.localsiteservice.rest.swagger;
 ...
 *
 * @author
 * @version SDNO 0.5 Mar 23, 2017
 */
@Path("/sdnolocalsite/v1")
@Controller("swaggerRoaResource")
public class SwaggerRoaResource {

    private static final Logger LOGGER = LoggerFactory.getLogger(SwaggerRoaResource.class);
